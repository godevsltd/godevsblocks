...
declare module '@wordpress/blocks' {
	...
	> {
		...
		attributes?: Record<
			keyof A,
			{ type: string; default?: unknown; [ k: string ]: unknown }
		>;
...
declare module '@wordpress/block-editor' {
	...
	export function useSelect< T >(
		selector: ( select: ( storeId: string ) => AnyProps ) => T
	): T;
...
declare module '@wordpress/components' {
	...
	export const PanelRow: ComponentType< {
		className?: string;
		children?: ReactNode;
	} >;
	export const PanelHeader: ComponentType< {
		label?: ReactNode;
		children?: ReactNode;
	} >;
	...
	export const ToolbarGroup: ComponentType< {
		children?: ReactNode;
		className?: string;
		[ k: string ]: unknown;
	} >;
	export const ToolbarDropdownMenu: ComponentType< {
		label: string;
		icon?: ReactNode;
		controls?: AnyProps[];
		toggleProps?: AnyProps;
		children?: ReactNode;
		[ k: string ]: unknown;
	} >;
	...
	export const ColorIndicator: ComponentType< {
		colorValue?: string;
		[ k: string ]: unknown;
	} >;
	export const ColorPalette: ComponentType< AnyProps >;
	...
	export const Disabled: ComponentType< {
		isDisabled?: boolean;
		children?: ReactNode;
	} >;
	...
	export const FlexItem: ComponentType< {
		isBlock?: boolean;
		children?: ReactNode;
		[ k: string ]: unknown;
	} >;
...
declare module '@wordpress/data' {
	...
	export function withSelect(
		mapSelectToProps: AnyProps
	): ( component: AnyProps ) => AnyProps;

	export function withDispatch(
		mapDispatchToProps: AnyProps
	): ( component: AnyProps ) => AnyProps;
}
