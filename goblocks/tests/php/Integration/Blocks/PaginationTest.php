...
use GoBlocks\Blocks\Pagination;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Pagination.
 *
...
class PaginationTest extends TestCase {
	...
	private Pagination $block;

	protected function setUp(): void {
		parent::setUp();
		$this->block = new Pagination();
	}
	...
	public function test_get_name(): void {
		self::assertSame( 'pagination', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-pagination', $html );
		self::assertStringContainsString( 'gb-pagination-test01', $html );
	}
