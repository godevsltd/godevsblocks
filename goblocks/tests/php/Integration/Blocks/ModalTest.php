...
use GoBlocks\Blocks\Modal;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Modal.
 *
...
class ModalTest extends TestCase {
	...
	public function test_get_name(): void {
		self::assertSame( 'modal', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-modal', $html );
		self::assertStringContainsString( 'gb-modal-test01', $html );
	}
