...
use GoBlocks\Blocks\Navigation;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Navigation.
 *
...
class NavigationTest extends TestCase {
	...
	public function test_get_name(): void {
		self::assertSame( 'navigation', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-navigation', $html );
		self::assertStringContainsString( 'gb-navigation-test01', $html );
	}
