...
use GoBlocks\Blocks\Lottie;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Lottie.
 *
...
class LottieTest extends TestCase {
	...
	private Lottie $block;

	protected function setUp(): void {
		parent::setUp();
		$this->block = new Lottie();
	}
	...
	public function test_get_name(): void {
		self::assertSame( 'lottie', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-lottie', $html );
		self::assertStringContainsString( 'gb-lottie-test01', $html );
	}
