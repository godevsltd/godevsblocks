...
use GoBlocks\Blocks\Button;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Button.
 *
...
class ButtonTest extends TestCase {
	...
	public function test_get_name(): void {
		self::assertSame( 'button', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-button', $html );
		self::assertStringContainsString( 'gb-button-test01', $html );
	}
