...
use GoBlocks\Blocks\Tabs;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Tabs.
 *
...
class TabsTest extends TestCase {
	...
	public function test_get_name(): void {
		self::assertSame( 'tabs', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-tabs', $html );
		self::assertStringContainsString( 'gb-tabs-test01', $html );
	}
