...
use GoBlocks\Blocks\Alert;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Alert.
 *
...
class AlertTest extends TestCase {
	...
	public function test_get_name(): void {
		self::assertSame( 'alert', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-alert', $html );
		self::assertStringContainsString( 'gb-alert-test01', $html );
	}
