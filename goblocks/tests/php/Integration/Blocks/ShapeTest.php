...
use GoBlocks\Blocks\Shape;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Shape.
 *
...
class ShapeTest extends TestCase {
	...
	public function test_get_name(): void {
		self::assertSame( 'shape', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-shape', $html );
		self::assertStringContainsString( 'gb-shape-test01', $html );
	}
