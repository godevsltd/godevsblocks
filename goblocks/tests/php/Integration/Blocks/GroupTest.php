...
use GoBlocks\Blocks\Group;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Group.
 *
...
class GroupTest extends TestCase {
	...
	public function test_get_name(): void {
		self::assertSame( 'group', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-group', $html );
		self::assertStringContainsString( 'gb-group-test01', $html );
	}
