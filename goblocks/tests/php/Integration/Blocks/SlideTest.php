...
use GoBlocks\Blocks\Slide;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Slide.
 *
...
class SlideTest extends TestCase {
	...
	public function test_get_name(): void {
		self::assertSame( 'slide', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-slide', $html );
		self::assertStringContainsString( 'gb-slide-test01', $html );
	}
