...
use GoBlocks\Blocks\Image;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Image.
 *
...
class ImageTest extends TestCase {
	...
	public function test_get_name(): void {
		self::assertSame( 'image', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-image', $html );
		self::assertStringContainsString( 'gb-image-test01', $html );
	}
