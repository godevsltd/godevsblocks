...
class AuthorAvatar extends TagBase {
	...
	public function get_label(): string {
		return __( 'Author Avatar URL', 'godevs-blocks' ); }
	/**
	...
	public function get_description(): string {
		return __( 'The Gravatar URL for the post author.', 'godevs-blocks' ); }
	/**
	...
	public function get_options(): array {
		return array(
			array(
				...
				'type'        => 'int',
				'default'     => 96,
				'description' => __( 'Avatar size in pixels.', 'godevs-blocks' ),
			),
		);
	}
