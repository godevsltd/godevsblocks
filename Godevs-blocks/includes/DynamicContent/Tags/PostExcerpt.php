...
class PostExcerpt extends TagBase {
	...
	public function get_label(): string {
		return __( 'Post Excerpt', 'godevs-block' ); }
	/**
	...
	public function get_description(): string {
		return __( 'The post excerpt (auto-generated if not set).', 'godevs-block' ); }
	/**
	...
	public function get_options(): array {
		return array(
			array(
				...
				'type'        => 'int',
				'default'     => 55,
				'description' => __( 'Word limit (0 = no limit).', 'godevs-block' ),
			),
			array(
				'key'         => 'more',
				'type'        => 'string',
				'default'     => '…',
				'description' => __( 'Trailing "more" text.', 'godevs-block' ),
			),
		);
	}
