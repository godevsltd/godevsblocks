	...
	public function render( array $attributes, string $content, WP_Block $block ): string {
		...
		$ordered = array(
			array(
				'show'  => $show_days,
				'key'   => 'days',
				'label' => __( 'Days', 'godevs-block' ),
			),
			array(
				'show'  => $show_hours,
				'key'   => 'hours',
				'label' => __( 'Hours', 'godevs-block' ),
			),
			array(
				'show'  => $show_minutes,
				'key'   => 'minutes',
				'label' => __( 'Minutes', 'godevs-block' ),
			),
			array(
				'show'  => $show_seconds,
				'key'   => 'seconds',
				'label' => __( 'Seconds', 'godevs-block' ),
			),
		);
		...
		return sprintf(
			...
			esc_attr( $classes ),
			esc_attr( $css_vars ),
			esc_attr( __( 'Countdown timer', 'godevs-block' ) ),
			$data,
			$units
		);
	}
