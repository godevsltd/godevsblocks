...
class Modal extends BlockBase {
	...
	public function render( array $attributes, string $content, WP_Block $block ): string {
		...
		$dismiss_html = $show_dismiss
			? sprintf( '<div class="gb-modal__footer"><button type="button" class="gb-modal__dismiss">%s</button></div>', esc_html__( 'Don\'t show again', 'godevs-block' ) )
			: '';
