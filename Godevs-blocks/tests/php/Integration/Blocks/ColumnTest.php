...
use GoBlocks\Blocks\Column;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Column.
 *
...
class ColumnTest extends TestCase {
	...
	private Column $block;

	protected function setUp(): void {
		parent::setUp();
		$this->block = new Column();
	}
	...
	public function test_get_name(): void {
		self::assertSame( 'column', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-column', $html );
		self::assertStringContainsString( 'gb-column-test01', $html );
	}
