...
use GoBlocks\Blocks\FlipCard;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\FlipCard.
 *
 * Covers: basic render, unique-ID class, empty-uniqueId early return,
 * global classes, and animation class pass-through.
 */
class FlipCardTest extends TestCase {

	private FlipCard $block;

	protected function setUp(): void {
		parent::setUp();
		$this->block = new FlipCard();
	}
	...
	public function test_get_name(): void {
		self::assertSame( 'flip-card', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-flip-card', $html );
		self::assertStringContainsString( 'gb-flip-card-test01', $html );
	}
