...
use GoBlocks\Blocks\Countdown;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Countdown.
 *
...
class CountdownTest extends TestCase {
	...
	private Countdown $block;

	protected function setUp(): void {
		parent::setUp();
		$this->block = new Countdown();
	}
	...
	public function test_get_name(): void {
		self::assertSame( 'countdown', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-countdown', $html );
		self::assertStringContainsString( 'gb-countdown-test01', $html );
	}
