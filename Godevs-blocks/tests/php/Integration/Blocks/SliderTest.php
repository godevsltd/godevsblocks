...
use GoBlocks\Blocks\Slider;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Slider.
 *
...
class SliderTest extends TestCase {
	...
	private Slider $block;

	protected function setUp(): void {
		parent::setUp();
		$this->block = new Slider();
	}
	...
	public function test_get_name(): void {
		self::assertSame( 'slider', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-slider', $html );
		self::assertStringContainsString( 'gb-slider-test01', $html );
	}
