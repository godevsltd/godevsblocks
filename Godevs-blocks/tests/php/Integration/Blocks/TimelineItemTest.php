...
use GoBlocks\Blocks\TimelineItem;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\TimelineItem.
 *
...
class TimelineItemTest extends TestCase {
	...
	private TimelineItem $block;

	protected function setUp(): void {
		parent::setUp();
		$this->block = new TimelineItem();
	}
	...
	public function test_get_name(): void {
		self::assertSame( 'timeline-item', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-timeline-item', $html );
		self::assertStringContainsString( 'gb-timeline-item-test01', $html );
	}
