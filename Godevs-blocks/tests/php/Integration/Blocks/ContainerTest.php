...
use GoBlocks\Blocks\Container;
use GoBlocks\Tests\TestCase;

/**
 * Integration tests for Blocks\Container.
 *
...
class ContainerTest extends TestCase {
	...
	public function test_get_name(): void {
		self::assertSame( 'container', $this->block->get_name() );
	}
	...
	public function test_render_outputs_block_class(): void {
		...
		self::assertStringContainsString( 'gb-container', $html );
		self::assertStringContainsString( 'gb-container-test01', $html );
	}
