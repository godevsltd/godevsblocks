...
export function IconInspector( {
	...
	const stylesContent = (
		<>
			...
			{ /* ── Background shape ─────────────────────────────────────── */ }
			<PanelBody
				title={ __( 'Background Shape', 'goblocks' ) }
				initialOpen={ false }
			>
				<SelectControl
				...
				{ hasBg && (
					<>
						...
						<RangeControl
							...
							value={ iconBgPadding }
							onChange={ ( v ) =>
								setAttributes( { iconBgPadding: v ?? 16 } )
							}
							min={ 4 }
							max={ 64 }
							// @ts-ignore
						...
						<ColorPicker
							...
							onChange={ ( v: string ) =>
								setAttributes( { iconBgHoverColor: v } )
							}
							enableAlpha
							defaultValue=""
						/>
				...
				{ hasAnimation && (
					<>
						...
						<SelectControl
							...
							onChange={ ( v ) =>
								setAttributes( { animationTrigger: v } )
							}
							// @ts-ignore
							__nextHasNoMarginBottom
						/>
						<SelectControl
							...
							onChange={ ( v ) =>
								setAttributes( { animationIterations: v } )
							}
							// @ts-ignore
							__nextHasNoMarginBottom
						/>
						<RangeControl
							...
							onChange={ ( v ) =>
								setAttributes( { animationDuration: v ?? 1 } )
							}
							min={ 0.2 }
							max={ 5 }
							step={ 0.1 }
						...
						<RangeControl
							...
							onChange={ ( v ) =>
								setAttributes( { animationDelay: v ?? 0 } )
							}
							min={ 0 }
							max={ 3 }
							step={ 0.1 }
			...
			<PanelBody title={ __( 'Icon', 'goblocks' ) } initialOpen>
				...
				{ showCustom && (
					<TextareaControl
						...
						value={ svgContent }
						onChange={ ( raw ) =>
							setAttributes( { svgContent: raw, iconSlug: '' } )
						}
						rows={ 6 }
						// @ts-ignore
						__nextHasNoMarginBottom
